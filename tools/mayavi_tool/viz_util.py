''' Visualization code for point clouds and 3D bounding boxes with mayavi_tool.
...
def draw_lidar(pc, color=None, fig=None, bgcolor=(0,0,0), pts_scale=1, pts_mode='point', pts_color=None):
    ...
    Args:
        ...
        fig: mayavi_tool figure handler, if None create new one otherwise will use it
    Returns:
...
def draw_gt_boxes3d(gt_boxes3d, fig, color=(1,1,1), line_width=1, draw_text=True, text_scale=(1,1,1), color_list=None):
    ...
    Args:
        ...
        fig: mayavi_tool figure handler
...
if __name__=='__main__':
    pc = np.loadtxt('mayavi_tool/kitti_sample_scan.txt')
    fig = draw_lidar(pc)
